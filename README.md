...
(1.1) Описание: Сложение двух строк с пробелом между ними.
```
Input: "Hello" + " World!"
Output: "Hello World!"
```
...
(1.3) Описание: Сложение двух длинных строк, результат — полное объединение.
```
...
(1.5) Описание: Сложение двух пустых строк, результат — пустая строка.
```
Input: "" + ""
Output: "" (пустая строка)
```

(1.6) Описание: Сложение строк, содержащих специальные символы.
```
Input: "Hello@123" + "!$%^&*"
Output: "Hello@123!$%^&*"
```

(1.7) Описание: Сложение двух строк с пробелами, результат — двойной пробел.
```
Input: " " + " "
Output: "  " (двойной пробел)
```

(1.8) Описание: Сложение непустой строки с пустой, результат — непустая строка.
```
Input: "Non-empty" + ""
Output: "Non-empty"
```

(1.9) Описание: Сложение длинных строк, результат — обрезка по длине.
```
Input: "This string is way too long and will definitely exceed the limit!" + " Adding more text!"
Output: "This string is way too long and will definitely ex..."
```
...
(2.3) Описание: Удаление подстроки из длинной строки, результат — модифицированная строка.
```
Input: "A long string that we will modify" - "long "
Output: "A string that we will modify"
```
...
(2.5) Описание: Вычитание несуществующей подстроки, результат — исходная строка.
```
...
(2.6) Описание: Удаление подстроки из строки, результат — оставшаяся часть.
```
Input: "A quick brown fox" - "quick "
Output: "A brown fox"
```
...
(3.4) Описание: Умножение строки на 10, результат — строка из 10 символов 'A'.
```
Input: "A" * 10
Output: "AAAAAAAAAA"
```
...
(4.3) Описание: Деление строки на 4, результат — первая четверть строки.
```
Input: "abcdef" / 4
Output: "ab"
```
...
(4.4) Описание: Деление короткой строки на 2, результат — первая половина.
```
Input: "Short" / 2
Output: "Sh"
```
...
(4.5) Описание: Деление строки на 10, результат — пустая строка, так как длина строки равна 10.
```
Input: "abcdefghij" / 10
Output: "" (пустая строка)
```
...
(4.6) Описание: Деление строки на 1, результат — исходная строка.
```
Input: "No change here!" / 1
Output: "No change here!"
```
...
(5.2) Описание: Сложение длинных строк, результат — обрезка по длине.
```
Input: "This is a very long string that exceeds the limit!" + " Another long string!"
Output: "This is a very long string that exceeds the limit! An..."
```


(5.3) Описание: Сложение очень длинной строки с символом, результат — обрезка.
```
...
(5.4) Описание: Сложение строки с символами и числом, результат — объединение.
```
Input: "Test!@#" + "123"
Output: "Test!@#123"
```
